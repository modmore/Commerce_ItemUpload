...
if (!createObject('modNamespace',array(
    'name' => 'commerce_itemupload',
    'path' => $componentPath.'/core/components/commerce_itemupload/',
    'assets_path' => $componentPath.'/assets/components/commerce_itemupload/',
),'name', false)) {
    echo "Error creating namespace commerce_itemupload.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemupload.core_path',
    'value' => $componentPath.'/core/components/commerce_itemupload/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemupload',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_itemupload.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemupload.assets_path',
    'value' => $componentPath.'/assets/components/commerce_itemupload/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemupload',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_itemupload.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_itemupload/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_itemupload.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_itemupload',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_itemupload.assets_url setting.\n";
}
...
$autoloadPath = $componentPath . '/core/components/commerce_itemupload/vendor/autoload.php';
